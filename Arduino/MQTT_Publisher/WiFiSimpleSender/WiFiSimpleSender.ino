...
const unsigned long interval = 10;  // 100 Hz = every 10ms
...
void loop() {
  ...
  mqttClient.beginMessage(topic, true, 2);  // quality of time: mqtt to return the message if the client looses connection
